...
const Page = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between pt-24 bg-[url(/TrustBg.svg)] h-[500px] md:h-[880px] bg-no-repeat bg-cover bg-[position:left] md:bg-[position:right]"></div>
        ...
        <div className="relative group w-full h-[692px] overflow-hidden cursor-pointer">
          ...
          <div className="absolute top-8 bottom-8 left-8 p-10 space-y-10 text-white h-auto w-[596px] bg-black/30 backdrop-blur-sm flex flex-col opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <p className="font-normal text-2xl max-w-lg">
              ...
              Cure+ Blood Bank, ensuring timely access to safe blood. The Trust
              remains committed to service, accessibility, and long-term impact
        ...
        <div className="relative group w-full h-[692px] overflow-hidden cursor-pointer">
          ...
          <div className="absolute top-8 bottom-8 right-8 p-10 space-y-10 text-white h-auto w-[596px] bg-black/30 backdrop-blur-sm flex flex-col opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <p className="font-normal text-2xl max-w-lg">
              ...
              across rural Karnataka. Based in Mysuru, it houses 2,000 units of
              blood, supporting Cure+ Hospitals in remote areas. Our mobile
        ...
        <div className="relative group w-full h-[692px] overflow-hidden  cursor-pointer">
          ...
          <div className="absolute top-8 bottom-8 left-8 p-10 space-y-10 text-white h-auto w-[596px] bg-black/30 backdrop-blur-sm flex flex-col opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <p className="font-normal text-2xl max-w-lg">
              ...
              collection, helping patients avoid exposure and travel costs. The
              SAV played a crucial role in providing healthcare to those unable
              to access services due to travel restrictions or safety concerns.
            </p>
          </div>
        </div>
      </main>
